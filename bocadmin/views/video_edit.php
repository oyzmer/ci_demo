...
<div class="btn-group"><a href="<?php echo site_urlc('video/index');?>" class="btn"> <i class="fa fa-arrow-left"></i> <?php echo lang('back_list')?> </a></div>
    ...
    <?php echo form_open(current_urlc(), array('class' => 'form-horizontal', 'id' => 'frm-edit')); ?>
        ...
        <div class="boxed-inner seamless">
            ...
            <div class="control-group">
             ...
             <div class="control-group">
                <label class="control-label" for="content"> 外部视频代码 </label>
                <div class="controls">
                   <textarea id="content" name="content"  style="width:300px;height:150px;"><?php echo set_value('content',$it['content']); ?></textarea>
                </div>
            </div>
                ...
                <div class="controls">
                    <div class="btn-group">
                        <span class="btn btn-success">
                            <i class="fa fa-upload"></i>
                            <span> <?php echo lang('upload_file') ?>  </span>
                             <input class="fileupload" type="file" accept="" data-for="video"  >
                        </span>
                        <input type="hidden" name="video" class="form-upload" data-more="0" value="<?php echo set_value('video',$it['video']) ?>">
...
require(['adminer/js/ui','adminer/js/media','bootstrap-datetimepicker.zh'],function(ui,media){
    ...
    var videos_photos = <?php echo json_encode(one_upload($it['photo'])) ?>;
    media.init();
    media.show(videos_photos,"photo");
     <?php if(!empty($it['video'])){ ?>
    // 图片
    var video_s = <?php echo json_encode(one_upload($it['video'])) ?>;
    media.show(video_s,'video');
    media.sort('video');
    <?php } ?>
});
</script>
