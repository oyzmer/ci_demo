<div class="btn-group">
    <a href="<?php echo site_urlc('gallery/create')?>" class='btn btn-primary'> <i class="fa fa-plus"></i> <?php echo $title; ?> </a>
</div>
...
require(['adminer/js/ui'],function(ui){
    var gallery = {
        url_del: "<?php echo site_urlc('gallery/delete'); ?>"
        ,url_audit: "<?php echo site_urlc('gallery/audit'); ?>"
        ,url_flag: "<?php echo site_urlc('gallery/flag'); ?>"
        ,url_sortid: "<?php echo site_urlc('gallery/sortid'); ?>"
        ,url_sort_change: "<?php echo site_urlc('gallery/sort_change'); ?>"
        ,url_copy: "<?php echo site_urlc('gallery/copypro'); ?>" 
    };
    ui.fancybox_img();
    ui.btn_delete(gallery.url_del);     // 删除
    ui.btn_audit(gallery.url_audit);    // 审核
    ui.btn_flag(gallery.url_flag);      // 推荐
    // ui.sortable(gallery.url_sortid); // 排序  拖动排序和序号排序在firefox中有bug
    ui.sort_change(gallery.url_sort_change); // input 排序
    ui.btn_copy(gallery.url_copy);    // 热门审核
});
</script>
