...
<div class="btn-group">
	<a href="<?php echo site_urlc('links/index')?>" class='btn'> <i class="fa fa-arrow-left"></i> <?php echo lang('back_list')?></a>
</div>
...
require(['adminer/js/ui','adminer/js/media','bootstrap-datetimepicker.zh'],function(ui,media){
	...
	// media 上传
	media.init();
	var linkss_photos = <?php echo json_encode(one_upload(set_value("photo"))) ?>;
