...
<div class="btn-group">
    <a href="<?php echo site_urlc('files/index')?>" class='btn'> <i class="fa fa-arrow-left"></i> <?php echo lang('back_list')?></a>
</div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="btn-group">
                        ...
                        <input type="hidden" name="attachment" class="form-upload" data-more="0" value="">
...
require(['adminer/js/ui','adminer/js/media','bootstrap-datetimepicker.zh'],function(ui,media){
    ...
    var attachment_s = <?php echo json_encode(one_upload(set_value("attachment"))) ?>;
