...
<div class="btn-group"><a href="<?php echo site_urlc('gallery/index');?>" class="btn"> <i class="fa fa-arrow-left"></i> <?php echo lang('back_list')?> </a></div>
...
require(['adminer/js/ui','adminer/js/media','bootstrap-datetimepicker.zh'],function(ui,media){
    ...
    var gallerys_photos = <?php echo json_encode(one_upload($it['photo'])) ?>;
    media.init();
