...
<div class="btn-group">
    <a href="<?php echo site_urlc('gallery/index')?>" class='btn'> <i class="fa fa-arrow-left"></i> <?php echo lang('back_list')?></a>
</div>
    ...
    <?php echo form_open(current_urlc(),array("class"=>"form-horizontal","id"=>"frm-create")); ?>
        ...
        <div class="boxed-inner seamless">
            ...
            <div class="clear"></div>
             <!-- 图片上传内页 -->
            <div class="control-group">
                <label for="img" class="control-label">多图展示</label>
                <div class="controls">
                    <div class="btn-group">
                        <span class="btn btn-success">
                            <i class="fa fa-upload"></i>
                        ...
                        <input type="hidden" name="photoinfo" class="form-upload" data-more="1" value="">
...
require(['adminer/js/ui','adminer/js/media','bootstrap-datetimepicker.zh'],function(ui,media){
    ...
    // media 上传
    media.init();
    var gallerys_photos = <?php echo json_encode(one_upload(set_value("photo"))) ?>;
    media.show(gallerys_photos,"photo");
    var photoinfo_s = <?php echo json_encode(list_upload(set_value("photoinfo"))) ?>;
