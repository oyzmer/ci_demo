...
<div class="btn-group"><a href="<?php echo site_urlc('files/index');?>" class="btn"> <i class="fa fa-arrow-left"></i> <?php echo lang('back_list')?> </a></div>
                ...
                <div class="controls">
                    <div class="btn-group">
                        <span class="btn btn-success">
                            <i class="fa fa-upload"></i>
                            <span> <?php echo lang('upload_file') ?>  </span>
                             <input class="fileupload" type="file" accept="" data-for="attachment"  >
                        </span>
                        <input type="hidden" name="attachment" class="form-upload" data-more="0" value="<?php echo set_value('attachment',$it['attachment']) ?>">

                    </div>
                </div>
            </div>
            <div id="js-attachment-show" class="js-img-list-f">
                <!-- 模板 #tpl-img-list -->
            </div>
...
require(['adminer/js/ui','adminer/js/media','bootstrap-datetimepicker.zh'],function(ui,media){
    ...
    // 图片
    var attachment_s = <?php echo json_encode(one_upload($it['attachment'])) ?>;
    media.show(attachment_s,'attachment');
    media.sort('attachment');
    <?php } ?>
});
</script>
