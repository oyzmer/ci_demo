...
<div class="btn-group">
    <a href="<?php echo site_urlc('video/index')?>" class='btn'> <i class="fa fa-arrow-left"></i> <?php echo lang('back_list')?></a>
</div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="btn-group">
                        ...
                        <input type="hidden" name="video" class="form-upload" data-more="0" value="">
...
require(['adminer/js/ui','adminer/js/media','bootstrap-datetimepicker.zh'],function(ui,media){
    ...
    media.init();
    var videos_photos = <?php echo json_encode(one_upload(set_value("photo"))) ?>;
    media.show(videos_photos,"photo");
    var video_s = <?php echo json_encode(one_upload(set_value("video"))) ?>;
